...
from .models import (
    Person, Artist, Genre, ArtistGenre, Impresario, Organizer, Contract,
    CulturalEvent, CulturalVenue, CulturalVenueType, EventVenue, ArtistContract, ArtistEvent
)
...
class ArtistAdmin(admin.ModelAdmin):
    list_display = ('person', 'is_national_artist', 'foreign_language', 'favorite_musical_instrument')
