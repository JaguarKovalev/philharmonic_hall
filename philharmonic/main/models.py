...
class Artist(models.Model):
    ...
    favorite_musical_instrument = models.CharField(max_length=255, blank=True, null=True)
...
class ArtistGenre(models.Model):
    ...
    genre = models.ForeignKey(Genre, on_delete=models.CASCADE, related_name='artist_genres')
...
class Impresario(models.Model):
    person = models.OneToOneField(Person, on_delete=models.CASCADE, related_name='impresario')
...
class Contract(models.Model):
    ...
    impresario = models.ForeignKey(Impresario, on_delete=models.CASCADE, related_name='contracts')
    organizer = models.ForeignKey(Organizer, on_delete=models.CASCADE, related_name='contracts')
...
class EventVenue(models.Model):
    ...
    cultural_venue = models.ForeignKey(CulturalVenue, on_delete=models.CASCADE, related_name='events')
    cultural_event = models.ForeignKey(CulturalEvent, on_delete=models.CASCADE, related_name='venues')
...
class ArtistContract(models.Model):
    ...
    artist = models.ForeignKey(Artist, on_delete=models.CASCADE, related_name='contracts')
    impresario = models.ForeignKey(Impresario, on_delete=models.CASCADE, related_name='artist_contracts')

    def __str__(self):
        return f"Contract with {self.artist} and {self.impresario} on {self.contract_date}"

# Relationship between artists and events
class ArtistEvent(models.Model):
    artist = models.ForeignKey(Artist, on_delete=models.CASCADE, related_name='artist_events')
    cultural_event = models.ForeignKey(CulturalEvent, on_delete=models.CASCADE, related_name='artist_events')
